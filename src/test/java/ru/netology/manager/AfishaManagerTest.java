...
//    private AfishaManager manager;
    Movie first = new Movie("first", "imageUrl1", "name1", "genre1");
    Movie second = new Movie("second", "imageUrl2", "name2", "genre2");
    Movie third = new Movie("third", "imageUrl3", "name3", "genre3");
